...
const Canvas = ({ signIn }) => {
  ...
  useEffect(() => {
    ...
    c.onmousemove = function (e) {
      ...
      if (
        c.width / 2 - 108 <= e.offsetX &&
        e.offsetX <= c.width / 2 - 108 + 205 &&
        c.height / 5 + 100 <= e.offsetY &&
        e.offsetY <= c.height / 5 + 100 + 65
      ) {
    ...
    c.onmousedown = function (e) {
      if (
        ...
        signIn();
        console.log("yeet hyperlink (firebase log in...) that boi..");
      }
    };
    ...
    function launchApp() {
      ctx.beginPath();
      ctx.roundRect(c.width / 2 - 108, c.height / 5 + 100, 205, 65, [20]);
      ...
      ctx.fillText("Launch App", c.width / 2 - 100, c.height / 5 + 145);
    }
  }, []);
